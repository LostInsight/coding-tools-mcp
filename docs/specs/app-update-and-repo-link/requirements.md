...
- **仓库主页**: 固定为 `https://github.com/LostInsight/coding-tools-mcp`。
- **Releases 最新页**: `https://github.com/LostInsight/coding-tools-mcp/releases/latest`。
...
1. WHEN 用户点击「检查更新」THEN 系统 SHALL 请求 GitHub `repos/LostInsight/coding-tools-mcp/releases/latest`，读取 `tag_name` 与 `html_url`。
