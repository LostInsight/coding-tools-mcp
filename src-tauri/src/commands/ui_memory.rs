...
mod tests {
    ...
    #[test]
    fn minimized_windows_sentinel_positions_are_rejected() {
        assert!(!is_sane_position(&PhysicalPosition::new(-32_000, -32_000)));
        assert!(!is_sane_position(&PhysicalPosition::new(50_000, 100)));
        assert!(is_sane_position(&PhysicalPosition::new(100, 100)));
    }

    #[test]
    fn unusable_window_sizes_are_rejected() {
