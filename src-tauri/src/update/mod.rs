...
pub const REPO_URL: &str = "https://github.com/LostInsight/coding-tools-mcp";
pub const RELEASES_LATEST_URL: &str = "https://github.com/LostInsight/coding-tools-mcp/releases/latest";
...
mod tests {
    ...
    fn parse_latest_detects_newer_release() {
        let body = r#"{
            "tag_name": "v0.1.99",
            "html_url": "https://github.com/LostInsight/coding-tools-mcp/releases/tag/v0.1.99"
        }"#;
    ...
    fn parse_latest_reports_up_to_date() {
        let body = r#"{
            "tag_name": "v0.1.23",
            "html_url": "https://github.com/LostInsight/coding-tools-mcp/releases/tag/v0.1.23"
        }"#;
        let result = parse_latest_release(body, "0.1.23").expect("parse");
        assert!(!result.update_available);
